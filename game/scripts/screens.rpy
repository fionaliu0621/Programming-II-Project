...
screen main_menu():
    imagemap:
        ...
        hotspot (112, 324, 262, 68) action Start()
        hotspot (112, 445, 258, 68) action ShowMenu("load")
        hotspot (112, 566, 271, 68) action ShowMenu("preferences")
        hotspot (112, 688, 255, 68) action ShowMenu("about")
        hotspot (112, 808, 249, 68) action ShowMenu("help")
        hotspot (112, 927, 264, 68) action Quit(confirm=False)
    # ## 這可確保替換任何其他選單畫面。
    # tag menu
